...
Generated from the current router-level queue semantics. `phase_count` is a derived topological view count, not an algorithmic phase in `effect_aware_dag`. Both planners now render explicit capacity-gate dependency edges before capacity-removing actions, and both lower preserved-slot updates during partial reconfiguration.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stage1 | `cost_aware_dag` | True | 21 | 18 | 9 | 9 | 9 | 0.004907 | 0.771133 | 28.122 | 0 | 0 | 3 | 0 | 1 |
| stage2 | `cost_aware_dag` | True | 50 | 51 | 7 | 7 | 9 | 0.010984 | 0.507989 | 48.349 | 0 | 2 | 1 | 0 | 0 |
| stage3 | `cost_aware_dag` | True | 28 | 29 | 18 | 18 | 8 | 0.005678 | 0.675795 | 30.64 | 0 | 0 | 3 | 0 | 1 |
| stage1 | `effect_aware_dag` | True | 21 | 18 | 9 | 9 | 9 | 0.004616 | 0.774133 | 28.122 | 0 | 0 | 3 | 0 | 1 |
| stage2 | `effect_aware_dag` | True | 50 | 51 | 7 | 7 | 9 | 0.010624 | 0.517783 | 48.349 | 0 | 2 | 1 | 0 | 0 |
| stage3 | `effect_aware_dag` | True | 21 | 19 | 13 | 13 | 8 | 0.004985 | 0.686591 | 29.08 | 0 | 0 | 3 | 0 | 1 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| stage1 | 0 | 0 | 0 | 0 | 0 | -0.000291 | 0.003 | 0.0 |
| stage2 | 0 | 0 | 0 | 0 | 0 | -0.00036 | 0.009794 | 0.0 |
| stage3 | -7 | -10 | -5 | -5 | 0 | -0.000693 | 0.010796 | -1.56 |
...
- **stage2 `cost_aware_dag`**: `{"activate_serving_route": 4, "clear_gpu_binding": 3, "clear_template": 3, "configure_partial_profile": 1, "delete_pods": 9, "deploy_target_workloads": 1, "mark_draining_instance": 13, "place_instance": 1, "register_mig_devices": 1, "return_gpu": 3, "stop_accepting_new": 5, "stop_gpu_traffic": 4, "workload_change": 2}`
- **stage3 `cost_aware_dag`**: `{"activate_serving_route": 4, "allocate_gpu": 3, "bind_target_gpu": 3, "clear_gpu_binding": 1, "clear_template": 1, "configure_full_template": 3, "delete_pods": 1, "deploy_target_workloads": 3, "mark_draining_instance": 3, "place_instance": 1, "register_mig_devices": 3, "return_gpu": 1, "stop_gpu_traffic": 1}`
