...
from cluster_state_manager.observed_layout import logical_mig_slots_from_bindings
from cluster_state_manager.pod_assignment_observer import observe_pod_assignments
