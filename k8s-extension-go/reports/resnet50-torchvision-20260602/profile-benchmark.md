...
|---|---:|
| client requests | 20 |
| client avg latency ms | 76.246 |
| client p50 latency ms | 74.875 |
| client p95 latency ms | 77.595 |

## Runtime Observations

| Runtime | Profile | Batch | Runtime ms | Runtime throughput | Router avg ms | Network overhead ms | Samples |
|---|---|---:|---:|---:|---:|---:|---:|
| resnet50-ampere-gpu0-s6-7-1g | 1g | 16 | 0.000 | 0.000 | 74.400 | 0.000 | 20 |

## Active Routes

| Runtime | GPU | Profile | Batch | Weight | Runtime ms | Endpoint ms | Network overhead ms |
|---|---|---|---:|---:|---:|---:|---:|
| resnet50-ampere-gpu0-s6-7-1g | ampere-gpu0 | 1g | 16 | 351.034 | 0.000 | 74.400 | 0.000 |
